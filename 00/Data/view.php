...
<body  id="page-mod-resource-view" class="format-weeks  path-mod path-mod-resource gecko dir-ltr lang-en yui-skin-sam yui3-skin-sam isis-tu-berlin-de pagelayout-incourse course-21135 context-1686324 cmid-911775 category-181 drawer-open-left site-isis">

    <div id="page-wrapper">

        <div>
    <a class="sr-only sr-only-focusable" href="#maincontent">Skip to main content</a>
</div><script src="https://isis.tu-berlin.de/lib/javascript.php/1603380481/lib/babel-polyfill/polyfill.min.js"></script>
<script src="https://isis.tu-berlin.de/lib/javascript.php/1603380481/lib/polyfills/polyfill.js"></script>
<script src="https://isis.tu-berlin.de/theme/yui_combo.php?rollup/3.17.2/yui-moodlesimple-min.js"></script><script src="https://isis.tu-berlin.de/lib/javascript.php/1603380481/lib/javascript-static.js"></script>
<script>
//<![CDATA[
...
//]]>
        ...
        <header id="mainheader" role="banner" class="pos-f-t navbar navbar-full navbar-light bg-faded navbar-static-top moodle-has-zindex nephthys-collapse">
                <a class="tub-nav" href="http://www.tu-berlin.de/menue/home/" alt="home of TUB" title="home of TUB">
                    <div class="tub-logo"></div>
                    <div class="return-home">home of TUB</div>
                </a>
            <div class="header-right">
                <a class="isis-hieroglyphics" target="_blank" href="https://de.wikipedia.org/wiki/Isis" alt="explanation for this hieroglyhph" title="explanation for this hieroglyhph"></a>
                <a class="home" href="https://isis.tu-berlin.de"></a>
                <div class="nav-right-top">
                    <nav class="nav navbar-nav">
                        <div class="tu-speeddial">
                            <div id="app-field" data-buttonsize="17"></div>
                        </div>
                        <script defer type="text/javascript" src="https://isis.tu-berlin.de/tu-speeddial/apps.js"></script>
                        <!-- custom_menu -->
                        <li class="nav-item">
    <a class="nav-item nav-link" href="https://isis.tu-berlin.de/mod/page/view.php?id=3" title="Imprint">Imprint</a>
</li><li class="nav-item">
    <a class="nav-item nav-link" href="https://isis.tu-berlin.de/mod/page/view.php?id=2" title="Contact">Contact</a>
</li><li class="nav-item">
    <a class="nav-item nav-link" href="https://isis.tu-berlin.de/mod/glossary/view.php?id=6&amp;mode=cat" title="Help">Help</a>
</li><li class="nav-item">
    <a class="nav-item nav-link" href="https://www.tu-berlin.de/menue/studium_lehre/sose_2020_digital/online_lehre/" target=\"_blank" >Covid-19-Info</a>
</li>
                        <!-- page_heading_menu -->
                ...
                <div class="action-menu-trigger">
                    <div class="dropdown">
                        <a href="#" tabindex="0" class="d-inline-block  dropdown-toggle icon-no-margin" id="action-menu-toggle-1" aria-label="User menu" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" aria-controls="action-menu-1-menu">
                            ...
                            <span class="userbutton"><span class="usertext mr-1">Anton Balthasar Jäkel</span><span class="avatars"><span class="avatar current"><img src="https://isis.tu-berlin.de/theme/image.php/nephthys/core/1603380481/u/f2" class="userpicture defaultuserpic" width="35" height="35" aria-hidden="true" /></span></span></span>
                                
                            <b class="caret"></b>
                        </a>
                            <div class="dropdown-menu dropdown-menu-right menu  align-tr-br" id="action-menu-1-menu" data-rel="menu-content" aria-labelledby="action-menu-toggle-1" role="menu" data-align="tr-br">
                                                                <a href="https://isis.tu-berlin.de/my/" class="dropdown-item menu-action" role="menuitem" data-title="mymoodle,admin" aria-labelledby="actionmenuaction-1">
                                <i class="icon fa fa-tachometer fa-fw " aria-hidden="true"  ></i>
                                <span class="menu-action-text" id="actionmenuaction-1">Dashboard</span>
                        </a>
                    <div class="dropdown-divider" role="presentation"><span class="filler">&nbsp;</span></div>
                                                                <a href="https://isis.tu-berlin.de/user/profile.php?id=79157" class="dropdown-item menu-action" role="menuitem" data-title="profile,moodle" aria-labelledby="actionmenuaction-2">
                                <i class="icon fa fa-user fa-fw " aria-hidden="true"  ></i>
                                <span class="menu-action-text" id="actionmenuaction-2">Profile</span>
                        </a>
                                                                <a href="https://isis.tu-berlin.de/grade/report/overview/index.php" class="dropdown-item menu-action" role="menuitem" data-title="grades,grades" aria-labelledby="actionmenuaction-3">
                                <i class="icon fa fa-table fa-fw " aria-hidden="true"  ></i>
                                <span class="menu-action-text" id="actionmenuaction-3">Grades</span>
                        </a>
                                                                <a href="https://isis.tu-berlin.de/message/index.php" class="dropdown-item menu-action" role="menuitem" data-title="messages,message" aria-labelledby="actionmenuaction-4">
                                <i class="icon fa fa-comment fa-fw " aria-hidden="true"  ></i>
                                <span class="menu-action-text" id="actionmenuaction-4">Messages</span>
                        </a>
                                                                <a href="https://isis.tu-berlin.de/user/preferences.php" class="dropdown-item menu-action" role="menuitem" data-title="preferences,moodle" aria-labelledby="actionmenuaction-5">
                                <i class="icon fa fa-wrench fa-fw " aria-hidden="true"  ></i>
                                <span class="menu-action-text" id="actionmenuaction-5">Preferences</span>
                        </a>
                    <div class="dropdown-divider" role="presentation"><span class="filler">&nbsp;</span></div>
                                                                <a href="https://isis.tu-berlin.de/login/logout.php?sesskey=LYgLNpQW8u" class="dropdown-item menu-action" role="menuitem" data-title="logout,moodle" aria-labelledby="actionmenuaction-6">
    ...
    id="nav-notification-popover-container" data-userid="79157"
    data-region="popover-region">
    <div class="popover-region-toggle nav-link"
        data-region="popover-region-toggle"
        role="button"
        aria-controls="popover-region-container-5f9c0dc2ac0bc5f9c0dc2a894510"
        aria-haspopup="true"
    ...
    <div 
        id="popover-region-container-5f9c0dc2ac0bc5f9c0dc2a894510"
        ...
        <a href="https://isis.tu-berlin.de/message/notificationpreferences.php?userid=79157"
        ...
        <div class="empty-message" tabindex="0" data-region="empty-message">You have no notifications</div>
            ...
            <span class="loading-icon icon-no-margin"><i class="icon fa fa-circle-o-notch fa-spin fa-fw "  title="Loading" aria-label="Loading"></i></span>
                ...
                <a class="see-all-link"
                    href="https://isis.tu-berlin.de/message/output/popup/notifications.php">
    ...
    <a id="message-drawer-toggle-5f9c0dc2adad85f9c0dc2a894511" class="nav-link d-inline-block popover-region-toggle position-relative" href="#"
            role="button">
        ...
        <div class="card ">
            <div class="card-body ">
                <div class="d-flex align-items-center">
                    <div class="mr-auto">
                        <div class="page-context-header"><div class="page-header-headings"><h1>[WiSe 2020/21] Machine Intelligence I: Supervised Methods</h1></div></div>
                    </div>
    ...
    <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="https://isis.tu-berlin.de/my/"  >Dashboard</a>
                </li>
        
                <li class="breadcrumb-item">My courses</li>
        
                <li class="breadcrumb-item">
                    <a href="https://isis.tu-berlin.de/course/view.php?id=21135"  title="[WiSe 2020/21] Machine Intelligence I: Supervised Methods">MI1 (WS 20/21)</a>
                </li>
        
                <li class="breadcrumb-item">Pre-Kickoff</li>
        
                <li class="breadcrumb-item">
                    <a href="https://isis.tu-berlin.de/mod/resource/view.php?id=911775" aria-current="page" title="File">natIMG</a>
                </li>
        </ol>
</nav>
                    </div>
                ...
                <div id="region-main-box" class="col-12">
                    <section id="region-main" >
                        <div class="card card-block">
                            ...
                            <div role="main"><span id="maincontent"></span><h2>natIMG</h2><div class="resourcecontent resourceimg"><img title="natIMG" class="resourceimage" src="https://isis.tu-berlin.de/pluginfile.php/1686324/mod_resource/content/0/natIMG.jpg" alt="" /></div><div id="resourceintro" class="box py-3 mod_introbox"><p class="resourcedetails">Uploaded 24/09/19, 13:56</p></div></div>
        ...
        <div
    id="drawer-5f9c0dc2ae7f95f9c0dc2a894512"
    ...
    tabindex="0"
>
            <div id="message-drawer-5f9c0dc2ae7f95f9c0dc2a894512" class="message-app" data-region="message-drawer" role="region">
            ...
            <div class="body-container position-relative" data-region="body-container">
                ...
                >
                ...
                </div>                <div class="hidden h-100" data-region="view-contacts" aria-hidden="true" data-user-id="79157">
                    <div class="d-flex flex-column h-100">
                        <div class="p-3 border-bottom">
                            <ul class="nav nav-pills nav-fill" role="tablist">
                                <li class="nav-item">
                                    <a
                                        id="contacts-tab-5f9c0dc2ae7f95f9c0dc2a894512"
                                        class="nav-link active"
                                        href="#contacts-tab-panel-5f9c0dc2ae7f95f9c0dc2a894512"
                                        data-toggle="tab"
                                        data-action="show-contacts-section"
                                        role="tab"
                                        aria-controls="contacts-tab-panel-5f9c0dc2ae7f95f9c0dc2a894512"
                                        aria-selected="true"
                                    >
                                        Contacts
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a
                                        id="requests-tab-5f9c0dc2ae7f95f9c0dc2a894512"
                                        class="nav-link"
                                        href="#requests-tab-panel-5f9c0dc2ae7f95f9c0dc2a894512"
                                        data-toggle="tab"
                                        data-action="show-requests-section"
                                        role="tab"
                                        aria-controls="requests-tab-panel-5f9c0dc2ae7f95f9c0dc2a894512"
                                        aria-selected="false"
                                    >
                                        Requests
                                        <span class="badge badge-primary bg-primary ml-2 hidden"
                    ...
                    data-user-id="79157"
                                        id="contacts-tab-panel-5f9c0dc2ae7f95f9c0dc2a894512"
                    data-section="contacts"
                    role="tabpanel"
                    aria-labelledby="contacts-tab-5f9c0dc2ae7f95f9c0dc2a894512"
                ...
                >
                    ...
                    data-region="lazy-load-list"
                    data-user-id="79157"
                                        id="requests-tab-panel-5f9c0dc2ae7f95f9c0dc2a894512"
                    data-section="requests"
                    role="tabpanel"
                    aria-labelledby="requests-tab-5f9c0dc2ae7f95f9c0dc2a894512"
                ...
                >
                    <div
                        ...
                        style="overflow-y: auto"
                    ></div>
                </div>                <div class="h-100 view-overview-body" aria-hidden="false" data-region="view-overview"  data-user-id="79157">
                    <div id="message-drawer-view-overview-container-5f9c0dc2ae7f95f9c0dc2a894512" class="d-flex flex-column h-100" style="overflow-y: auto">
                            ...
                            >
                                <div id="view-overview-favourites-toggle" class="card-header p-0" data-region="toggle">
                                    <button
                                        ...
                                        data-target="#view-overview-favourites-target-5f9c0dc2ae7f95f9c0dc2a894512"
                                        aria-expanded="false"
                                        aria-controls="view-overview-favourites-target-5f9c0dc2ae7f95f9c0dc2a894512"
                                    >
                                ...
                                data-region="lazy-load-list"
                                data-user-id="79157"
                                            id="view-overview-favourites-target-5f9c0dc2ae7f95f9c0dc2a894512"
            aria-labelledby="view-overview-favourites-toggle"
            data-parent="#message-drawer-view-overview-container-5f9c0dc2ae7f95f9c0dc2a894512"
                            ...
                            >
                                <div id="view-overview-group-messages-toggle" class="card-header p-0" data-region="toggle">
                                    <button
                                        class="btn btn-link w-100 text-left p-1 p-sm-2 d-flex align-items-center overview-section-toggle collapsed"
                                        data-toggle="collapse"
                                        data-target="#view-overview-group-messages-target-5f9c0dc2ae7f95f9c0dc2a894512"
                                        aria-expanded="false"
                                        aria-controls="view-overview-group-messages-target-5f9c0dc2ae7f95f9c0dc2a894512"
                                    >
                                        <span class="collapsed-icon-container">
                                            <i class="icon fa fa-caret-right fa-fw " aria-hidden="true"  ></i>
                                        </span>
                                ...
                                data-region="lazy-load-list"
                                data-user-id="79157"
                                            id="view-overview-group-messages-target-5f9c0dc2ae7f95f9c0dc2a894512"
                            ...
                            >
                                <div id="view-overview-messages-toggle" class="card-header p-0" data-region="toggle">
                                    <button
                                        class="btn btn-link w-100 text-left p-1 p-sm-2 d-flex align-items-center overview-section-toggle collapsed"
                                        data-toggle="collapse"
                                        data-target="#view-overview-messages-target-5f9c0dc2ae7f95f9c0dc2a894512"
                                        aria-expanded="false"
                                        aria-controls="view-overview-messages-target-5f9c0dc2ae7f95f9c0dc2a894512"
                                    >
                                        <span class="collapsed-icon-container">
                                            <i class="icon fa fa-caret-right fa-fw " aria-hidden="true"  ></i>
                                        </span>
                                ...
                                data-region="lazy-load-list"
                                data-user-id="79157"
                                            id="view-overview-messages-target-5f9c0dc2ae7f95f9c0dc2a894512"
                        ...
                        <div data-region="settings" class="p-3">
                                    ...
                                    <legend class="sr-only">Accept messages from:</legend>
                                        <div class="custom-control custom-radio mb-2">
                                            <input
                                                ...
                                                id="block-noncontacts-5f9c0dc2ae7f95f9c0dc2a894512-1"
                                                value="1"
                                            >
                                            <label class="custom-control-label ml-2" for="block-noncontacts-5f9c0dc2ae7f95f9c0dc2a894512-1">
                                                My contacts only
                                            </label>
                                        </div>
                                        <div class="custom-control custom-radio mb-2">
                                            <input
                                                ...
                                                name="message_blocknoncontacts"
                                                class="custom-control-input"
                                                id="block-noncontacts-5f9c0dc2ae7f95f9c0dc2a894512-0"
                                                value="0"
                                            >
                                            <label class="custom-control-label ml-2" for="block-noncontacts-5f9c0dc2ae7f95f9c0dc2a894512-0">
                            ...
                            <div data-preference="entertosend">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" id="enter-to-send-5f9c0dc2ae7f95f9c0dc2a894512" >
                                    <label class="custom-control-label" for="enter-to-send-5f9c0dc2ae7f95f9c0dc2a894512">
                                        Use enter to send
                                    </label>
                                </div>
                            </div>
            ...
            <div class="footer-container position-relative" data-region="footer-container">
                ...
                >
                    ...
                    ></div>
                        ...
                        <a href="https://isis.tu-berlin.de/message/index.php">
                            See all
                        </a>
                    </div>
            </div>
        ...
        <footer id="page-footer" class="p-y-1">
            <div class="logo-container">
                <a href="http://www.innocampus.tu-berlin.de/" class="inno-campus-logo" alt="innoCampus"></a>
            </div>
            <div class="content-container">
                <div id="course-footer"></div>

                <div class="logininfo">You are logged in as <a href="https://isis.tu-berlin.de/user/profile.php?id=79157" title="View profile">Anton Balthasar Jäkel</a> (<a href="https://isis.tu-berlin.de/login/logout.php?sesskey=LYgLNpQW8u">Log out</a>)</div>
                <div class="tool_usertours-resettourcontainer"></div>
                <div class="homelink"><a href="https://isis.tu-berlin.de/course/view.php?id=21135">MI1 (WS 20/21)</a></div>
                <nav class="nav navbar-nav hidden-lg-up">
                    <ul class="list-unstyled p-t-1">
                        <li><a href="https://isis.tu-berlin.de/mod/page/view.php?id=3" title="Imprint">Imprint</a> &nbsp;&#183;&nbsp;
                            <a href="https://isis.tu-berlin.de/admin/tool/policy/view.php?policyid=1" title="Terms of Use">Terms of Use</a> &nbsp;&#183;&nbsp;
                            <a href="https://isis.tu-berlin.de/admin/tool/policy/view.php?policyid=2" title="Privacy">Privacy</a></li>
                        <li>&nbsp;</li>
                        <li><a href="http://www.innocampus.tu-berlin.de/" title="powered by innoCampus">powered by innoCampus</a></li>
                    </ul>
                    <!--
                         <ul class="list-unstyled p-t-1">
                                         <li><a href="https://isis.tu-berlin.de/mod/page/view.php?id=3" title="Imprint">Imprint</a></li>
                                         <li><a href="https://isis.tu-berlin.de/mod/page/view.php?id=2" title="Contact">Contact</a></li>
                                         <li><a href="https://isis.tu-berlin.de/mod/glossary/view.php?id=6&amp;mode=cat" title="Help">Help</a></li>
                                         <li><a href="https://www.tu-berlin.de/menue/studium_lehre/sose_2020_digital/online_lehre/" target=\"_blank" title="">Covid-19-Info</a></li>
                         </ul>
                          -->
                </nav>
                <div class="policiesfooter"><a href="https://isis.tu-berlin.de/admin/tool/policy/viewall.php?returnurl=https%3A%2F%2Fisis.tu-berlin.de%2Fmod%2Fresource%2Fview.php%3Fid%3D911775">Policies</a></div>
            </div>
        </footer>

        <div data-region="drawer-toggle" class="custom-drawer-toggle nephthys-collapse" id="custom-drawer-toggle">
          <button aria-expanded="true" aria-controls="nav-drawer" type="button" class="btn pull-xs-left m-r-1 btn-secondary" data-action="toggle-drawer" data-side="left" data-preference="drawer-open-nav"></button>
        </div>
        
        <div id="nav-drawer" data-region="drawer" class="hidden-print moodle-has-zindex nephthys-collapse " aria-hidden="false" tabindex="-1">
        
          <!-- custom search -->
          <form action="https://isis.tu-berlin.de/course/search.php" method="get" class="nav-search">
            <div class="nav-search-wrapper"><input id="navsearchbox" name="search" type="text" size="12" value="" autocomplete="off" placeholder="search + press enter" class="form-control"></div>
          </form>
          <div id="isis-admin-indicator"></div>
          <!-- custom search -->
          <nav class="list-group">
              <a class="list-group-item list-group-item-action " href="https://isis.tu-berlin.de/course/view.php?id=21135" data-key="coursehome" data-isexpandable="0" data-indent="0" data-showdivider="0" data-type="60" data-nodetype="0" data-collapse="0" data-forceopen="0" data-isactive="0" data-hidden="0" data-preceedwithhr="0" >
                  <div class="m-l-0">
                      <div class="media">
                          <span class="media-left">
                              <i class="icon fa fa-graduation-cap fa-fw " aria-hidden="true"  ></i>
                          </span>
                          <span class="media-body ">MI1 (WS 20/21)</span>
                      </div>
                  </div>
              </a>
              <a class="list-group-item list-group-item-action " href="https://isis.tu-berlin.de/user/index.php?id=21135" data-key="participants" data-isexpandable="0" data-indent="0" data-showdivider="0" data-type="90" data-nodetype="1" data-collapse="0" data-forceopen="0" data-isactive="0" data-hidden="0" data-preceedwithhr="0" data-parent-key="21135">
                  <div class="m-l-0">
                      <div class="media">
                          <span class="media-left">
              ...
              <a class="list-group-item list-group-item-action " href="https://isis.tu-berlin.de/grade/report/index.php?id=21135" data-key="grades" data-isexpandable="0" data-indent="0" data-showdivider="0" data-type="70" data-nodetype="0" data-collapse="0" data-forceopen="0" data-isactive="0" data-hidden="0" data-preceedwithhr="0" data-parent-key="21135">
                  <div class="m-l-0">
                      <div class="media">
                          <span class="media-left">
                              <i class="icon fa fa-table fa-fw " aria-hidden="true"  ></i>
              ...
              <a class="list-group-item list-group-item-action " href="https://isis.tu-berlin.de/local/isis/videochat.php?courseid=21135" data-key="videochat" data-isexpandable="0" data-indent="0" data-showdivider="0" data-type="60" data-nodetype="0" data-collapse="0" data-forceopen="0" data-isactive="0" data-hidden="0" data-preceedwithhr="0" data-parent-key="21135">
                  <div class="m-l-0">
                      <div class="media">
                          <span class="media-left">
                              <i class="icon fa fa-caret-right fa-fw " aria-hidden="true"  ></i>
                          </span>
                          <span class="media-body ">meet@ISIS</span>
                      </div>
                  </div>
              </a>
          </nav>
          <nav class="list-group m-t-1">
              <a class="list-group-item list-group-item-action " href="https://isis.tu-berlin.de/my/" data-key="myhome" data-isexpandable="0" data-indent="0" data-showdivider="1" data-type="1" data-nodetype="1" data-collapse="0" data-forceopen="1" data-isactive="0" data-hidden="0" data-preceedwithhr="0" >
                  <div class="m-l-0">
                      <div class="media">
                          <span class="media-left">
                              <i class="icon fa fa-tachometer fa-fw " aria-hidden="true"  ></i>
              ...
              <a class="list-group-item list-group-item-action " href="https://isis.tu-berlin.de/?redirect=0" data-key="home" data-isexpandable="0" data-indent="0" data-showdivider="0" data-type="70" data-nodetype="0" data-collapse="0" data-forceopen="0" data-isactive="0" data-hidden="0" data-preceedwithhr="0" data-parent-key="myhome">
                  <div class="m-l-0">
                      <div class="media">
                          <span class="media-left">
              ...
              <a class="list-group-item list-group-item-action " href="https://isis.tu-berlin.de/calendar/view.php?view=month&amp;course=21135" data-key="calendar" data-isexpandable="0" data-indent="0" data-showdivider="0" data-type="60" data-nodetype="0" data-collapse="0" data-forceopen="0" data-isactive="0" data-hidden="0" data-preceedwithhr="0" data-parent-key="1">
                  <div class="m-l-0">
                      <div class="media">
                          <span class="media-left">
              ...
              <a class="list-group-item list-group-item-action " href="https://isis.tu-berlin.de/course/view.php?id=21050" data-key="21050" data-isexpandable="1" data-indent="1" data-showdivider="0" data-type="20" data-nodetype="1" data-collapse="0" data-forceopen="0" data-isactive="0" data-hidden="0" data-preceedwithhr="0" data-parent-key="mycourses">
                  <div class="m-l-1">
                      <div class="media">
                          <span class="media-left">
                              <i class="icon fa fa-graduation-cap fa-fw " aria-hidden="true"  ></i>
                          </span>
                          <span class="media-body ">[WiSe 20/21] PyML</span>
                      </div>
                  </div>
              </a>
              <a class="list-group-item list-group-item-action " href="https://isis.tu-berlin.de/course/view.php?id=22368" data-key="22368" data-isexpandable="1" data-indent="1" data-showdivider="0" data-type="20" data-nodetype="1" data-collapse="0" data-forceopen="0" data-isactive="0" data-hidden="0" data-preceedwithhr="0" data-parent-key="mycourses">
                  <div class="m-l-1">
                      <div class="media">
                          <span class="media-left">
                              <i class="icon fa fa-graduation-cap fa-fw " aria-hidden="true"  ></i>
                          </span>
                          <span class="media-body ">DBT WS20/21</span>
                      </div>
                  </div>
              </a>
              <a class="list-group-item list-group-item-action " href="https://isis.tu-berlin.de/course/view.php?id=21123" data-key="21123" data-isexpandable="1" data-indent="1" data-showdivider="0" data-type="20" data-nodetype="1" data-collapse="0" data-forceopen="0" data-isactive="0" data-hidden="0" data-preceedwithhr="0" data-parent-key="mycourses">
                  <div class="m-l-1">
                      <div class="media">
                          <span class="media-left">
                              <i class="icon fa fa-graduation-cap fa-fw " aria-hidden="true"  ></i>
                          </span>
                          <span class="media-body ">[WiSe 20/21] ML1</span>
                      </div>
                  </div>
              </a>
              <a class="list-group-item list-group-item-action " href="https://isis.tu-berlin.de/course/view.php?id=21135" data-key="21135" data-isexpandable="1" data-indent="1" data-showdivider="0" data-type="20" data-nodetype="1" data-collapse="0" data-forceopen="1" data-isactive="0" data-hidden="0" data-preceedwithhr="0" data-parent-key="mycourses">
                  <div class="m-l-1">
                      <div class="media">
                          <span class="media-left">
                              <i class="icon fa fa-graduation-cap fa-fw " aria-hidden="true"  ></i>
              ...
              <a class="list-group-item list-group-item-action " href="https://isis.tu-berlin.de/course/view.php?id=21541" data-key="21541" data-isexpandable="1" data-indent="1" data-showdivider="0" data-type="20" data-nodetype="1" data-collapse="0" data-forceopen="0" data-isactive="0" data-hidden="0" data-preceedwithhr="0" data-parent-key="mycourses">
                  <div class="m-l-1">
                      <div class="media">
                          <span class="media-left">
                              <i class="icon fa fa-graduation-cap fa-fw " aria-hidden="true"  ></i>
                          </span>
                          <span class="media-body ">Microeconometrics WS 20/21</span>
                      </div>
                  </div>
              </a>
              <a class="list-group-item list-group-item-action " href="https://isis.tu-berlin.de/course/view.php?id=16781" data-key="16781" data-isexpandable="1" data-indent="1" data-showdivider="0" data-type="20" data-nodetype="1" data-collapse="0" data-forceopen="0" data-isactive="0" data-hidden="0" data-preceedwithhr="0" data-parent-key="mycourses">
                  <div class="m-l-1">
                      <div class="media">
                          <span class="media-left">
                              <i class="icon fa fa-graduation-cap fa-fw " aria-hidden="true"  ></i>
                          </span>
                          <span class="media-body ">DataScience&amp;Engineering Track</span>
                      </div>
                  </div>
              </a>
          </nav>
...
//<![CDATA[
var require = {
    baseUrl : 'https://isis.tu-berlin.de/lib/requirejs.php/1603380481/',
    ...
    paths: {
        jquery: 'https://isis.tu-berlin.de/lib/javascript.php/1603380481/lib/jquery/jquery-3.4.1.min',
        jqueryui: 'https://isis.tu-berlin.de/lib/javascript.php/1603380481/lib/jquery/ui-1.12.1/jquery-ui.min',
        jqueryprivate: 'https://isis.tu-berlin.de/lib/javascript.php/1603380481/lib/requirejs/jquery-private'
    },
...
<script src="https://isis.tu-berlin.de/lib/javascript.php/1603380481/lib/requirejs/require.min.js"></script>
<script>
//<![CDATA[
M.util.js_pending("core/first");require(['core/first'], function() {
require(['core/prefetch']);
;
M.util.js_pending('local_isis/nav-courses'); require(['local_isis/nav-courses'], function(amd) {amd.init([]); M.util.js_complete('local_isis/nav-courses');});;
...
function(
    ...
    var toggle = $('#message-drawer-toggle-5f9c0dc2adad85f9c0dc2a894511');
    Popover.init(toggle);
});
;

require(['jquery', 'core_message/message_drawer'], function($, MessageDrawer) {
    var root = $('#message-drawer-5f9c0dc2ae7f95f9c0dc2a894512');
    MessageDrawer.init(root, '5f9c0dc2ae7f95f9c0dc2a894512', false);
});
;
...
$('.nephthys-collapse, #page, body').addClass('nephthys-shrink');

} else {
$('.nephthys-collapse, #page, body').removeClass('nephthys-shrink');
}
});
}
...
;
M.util.js_pending('core/notification'); require(['core/notification'], function(amd) {amd.init(1686324, [], true); M.util.js_complete('core/notification');});;
...
M.util.help_popups.setup(Y);
 M.util.js_pending('random5f9c0dc2a894513'); Y.on('domready', function() { M.util.js_complete("init");  M.util.js_complete('random5f9c0dc2a894513'); });
})();
//]]>
</script>
